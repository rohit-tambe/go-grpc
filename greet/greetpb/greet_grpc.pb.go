...
type GreetServiceClient interface {
	...
	// UNARY request
	SayHelloName(ctx context.Context, in *SayHello, opts ...grpc.CallOption) (*SayHello, error)
	// Server Streaming
...
func (c *greetServiceClient) SayHelloName(ctx context.Context, in *SayHello, opts ...grpc.CallOption) (*SayHello, error) {
	out := new(SayHello)
	err := c.cc.Invoke(ctx, "/greet.GreetService/SayHelloName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	// UNARY request
	SayHelloName(context.Context, *SayHello) (*SayHello, error)
	// Server Streaming
...
func (UnimplementedGreetServiceServer) SayHelloName(context.Context, *SayHello) (*SayHello, error) {
...
func _GreetService_SayHelloName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SayHello)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).SayHelloName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/SayHelloName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).SayHelloName(ctx, req.(*SayHello))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GreetService_SayHelloName_Handler,
		},
	},
